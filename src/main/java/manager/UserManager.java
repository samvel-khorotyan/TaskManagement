...
public class UserManager {
    ...
    public boolean register(User user) {
        ...
        String sql = "INSERT INTO taskmanagement.user (name,surname,email,password,type,picture_url) VALUES(?,?,?,?,?,?)";
    ...
    public boolean update(User user) {
        ...
        String sql = "UPDATE taskmanagement.user SET name = ?, surname = ?, email = ?, password = ?, type = ?, picture_url = ? WHERE id = ?";
